...
var app = new Vue({
	...
	methods:{
		startCheck: function(){//讀取cookie 初始化
			...
			const startmessage = [
			"小知識：想重新命名？左下角那個會動的東西是功能鍵喔！",
			"小知識：想私下聊？打#加文字就能開小房間喔（範例:#秘密小房間)",
			"小知識：為了保護隱私，離開頁面對話紀錄將不保留，請多利用新分頁來對話喔！",
			"小知識：路邊遇到可憐的小貓，請在遠處等待，貓媽媽可能就在附近！",
			"小知識：抱身體較長的狗狗（臘腸、柯基...），要用雙手將狗狗平行抱起",
			"小知識：貓咪是最機掰的生物"
			];
